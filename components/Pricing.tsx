...
export default function Pricing({ onOpenChat }: PricingProps) {
  ...
  const tiers = [
    ...
    },
    {
      ...
      deliverables: [
        'Everything in Lead Recovery',
        'AI Chat Agent (3 agents)',
    ...
    },
    {
      ...
      deliverables: [
        'Everything in Efficiency Suite',
        'AI Voice Agent',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-stretch">
          {tiers.map((tier, idx) => (
            ...
            >
              ...
              <button 
                onClick={onOpenChat}
                className={`w-full py-3 font-bold rounded-lg transition-all mb-8 shadow-lg flex items-center justify-center gap-2 ${
                tier.highlight 
